...
enum TOKENS {
	...
	STRING_VARIABLE,		/* 19: String Token */
	FLOAT_LITERAL			/* 20: Float Token */
};
...
#define OR_CHR '|'		// CH27
// Additional symbols
#define INT_CHR 'i'		// CH28
#define WOR_CHR '@'		// Ch29
#define VAR_CHR '$'		// CH30
#define FLT_CHR 'f'		// CH31
...
typedef struct languageAttributes {
	word_s indentationCharType;
	word_s indentationCurrentPos;
	/* TO_DO: Include any extra attribute to be used in your scanner (OPTIONAL and FREE) */
} LanguageAttributes;

/* Number of errors */
word_s numScannerErrors;
